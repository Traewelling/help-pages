...
![Station von Wikidata importieren](/features/manual-trips/wikidata/form-wikidata.png)

Wenn beim Import nichts passiert, lässt sich diese Art von Station bei uns noch nicht anlegen.
[Sag uns gerne Bescheid](../../../support/report-bugs/index.md), dann schauen wir uns den Fall an.
