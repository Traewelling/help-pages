...
You can find out how to help with that under [Timetable licensing](licensing/index.md).

### What you can do

- Create your [trip manually](../manual-trips/index.md). That always works, even if the connection is missing here.
  If a station is missing there, you can
  [import it from Wikidata](../manual-trips/index.md#add-new-stations-wikidata-import).
- Help us with a missing license, see [Timetable licensing](licensing/index.md).
- Add or update a timetable at Transitous, see [Transitous](transitous/index.md).
